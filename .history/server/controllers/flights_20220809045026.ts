...
export function DisplayCheckoutTable(req: express.Request, res: express.Response, next: express.NextFunction)
{
  oracledb.getConnection(
    ...
    async (err, connection) => {
      ...
      const ticket:oracledb.Result<any> = await connection.execute(`
      SELECT cal_tax(o.id_booking), f.airline, t.position,t.id_ticket, f.take_off_time, f.arrival_time, f.from_airport, f.to_airport, t.price FROM pj_customers c ,pj_orders o, pj_ticket t, pj_flight f
